...
function prompt {
    if ($isAdmin) { "PS " + $PSVersionTable.PSVersion.ToString() +" ADMIN >" } else {"PS " + $PSVersionTable.PSVersion.ToString() +" >"}
}
$Host.ui.RawUI.WindowTitle = "Doing PowerShell Stuff Here"

##To start my powershell instance in the folder I want.
# Checking for correct path
<#
if (Test-Path -Path "<PATH to your folder>")
{
	Set-Location -Path "<PATH to your folder>"
}
else
{
	Set-Location -Path "<NEW PATH to your folder>"
}
#Set-Location -Path "<PATH to your folder>"
#>
# /configuration
...
# shortcuts for longer object names
Set-Alias -Name c -Value Clear-Host
Set-Alias -Name ep -Value Edit-Profile
Set-Alias -Name ga -Value Get-Alias

# shortcuts for my functions
Set-Alias -Name profiles -Value Show-Profile # my function
Set-Alias -Name fxf -Value Explorer-Function # my function

# /Set aliases

# Enhanced Listing
# Aliases could just be a name of a function also
function la { Get-ChildItem | Format-Table -AutoSize }
function ll { Get-ChildItem -Force | Format-Table -AutoSize }

# All Functions
function Explorer-Function {
    explorer .
}
...
$EDITOR = if (Test-CommandExists code) { 'code' }
          elseif (Test-CommandExists notepad.exe) { 'notepad' } 
...
$($PSStyle.Foreground.Green)Show-Profile$($PSStyle.Reset) - Lists all profiles.
...
$($PSStyle.Foreground.Green)c$($PSStyle.Reset) - Clears the screen.

$($PSStyle.Foreground.Green)fxf$($PSStyle.Reset) - Opens Explorer at the currect directory.
